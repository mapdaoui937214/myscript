...
local function createUI()
    ...
    warnMsg.Text = "Destroy all items in backpack?\nThis is forced."
    ...
    toggleBtn.MouseButton1Click:Connect(function()
        ...
        toggleBtn.Text = getgenv().FallResetConfig.Enabled and "Destroy: ON" or "Destroy: OFF"
...
local function monitor(char)
    ...
    local function deleteItems(container)
    ...
    RunService.Heartbeat:Connect(function()
        if getgenv().FallResetConfig.Enabled and hrp.Position.Y < getgenv().FallResetConfig.Threshold then
            if LocalPlayer:FindFirstChild("Backpack") then deleteItems(LocalPlayer.Backpack) end
            deleteItems(char)
