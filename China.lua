...
-- Key System Configuration (3 types of keys)
...
KeyTitle.Text = "China hub - Key System"
...
Main.Size = UDim2.new(0, 200, 0, 580)
...
local function createTPSection()
    ...
    input.Size, input.PlaceholderText, input.Text = UDim2.new(1, 0, 0, 30), "プレイヤー名(短縮可)", ""
    ...
    btn.Size, btn.Position, btn.Text = UDim2.new(1, 0, 0, 35), UDim2.new(0, 0, 0, 40), "Teleport to Player"
    btn.BackgroundColor3, btn.TextColor3, btn.Font, btn.TextSize = Color3.fromRGB(0, 120, 200), Color3.new(1, 1, 1), Enum.Font.SourceSansBold, 15
...
MinBtn.MouseButton1Click:Connect(function()
    ...
    Main:TweenSize(isMin and UDim2.new(0, 200, 0, 40) or UDim2.new(0, 200, 0, 580), "Out", "Quart", 0.3, true)
end)
