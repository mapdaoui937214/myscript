...
MinBtn.MouseButton1Click:Connect(function()
    ...
    if isMinimized then
        ...
        TweenService:Create(Main, TweenInfo.new(0.3, Enum.EasingStyle.Quart, Enum.EasingDirection.Out), {Size = UDim2.new(0, 60, 0, 60)}):Play()
        TweenService:Create(MainCorner, TweenInfo.new(0.3, Enum.EasingStyle.Quart, Enum.EasingDirection.Out), {CornerRadius = UDim.new(1, 0)}):Play()
        TweenService:Create(GlowCorner, TweenInfo.new(0.3, Enum.EasingStyle.Quart, Enum.EasingDirection.Out), {CornerRadius = UDim.new(1, 0)}):Play()
    else
        Scroll.Visible = true
        Title.Visible = true
        ...
        TweenService:Create(Main, TweenInfo.new(0.3, Enum.EasingStyle.Quart, Enum.EasingDirection.Out), {Size = UDim2.new(0, 240, 0, 480)}):Play()
        TweenService:Create(MainCorner, TweenInfo.new(0.3, Enum.EasingStyle.Quart, Enum.EasingDirection.Out), {CornerRadius = UDim.new(0, 10)}):Play()
        TweenService:Create(GlowCorner, TweenInfo.new(0.3, Enum.EasingStyle.Quart, Enum.EasingDirection.Out), {CornerRadius = UDim.new(0, 12)}):Play()
    end
end)
...
``` Would you like me to add a custom icon or any other functions to your hub?
